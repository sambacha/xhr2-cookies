...
var XMLHttpRequest = /** @class */ (function (_super) {
    ...
    XMLHttpRequest.prototype._finalizeHeaders = function () {
        var host = this._loweredHeaders['host'] ? this._headers[this._loweredHeaders['host']] : this._url.host;
        this._headers = __assign(__assign(__assign({}, this._headers), { Connection: 'keep-alive', Host: host, 'User-Agent': this._userAgent }), this._anonymous ? { Referer: 'about:blank' } : {});
    ...
    XMLHttpRequest.REFUSE_UNSAFE_HEADER = true;
